...
async def start_cmd(bot, message):
    ...
    await message.reply_photo(photo=Rkn_Bots.RKN_PIC,
        ...
        reply_markup=types.InlineKeyboardMarkup([[
            types.InlineKeyboardButton('MY OWNER', url='https://t.me/greenmoviesbot'),
            types.InlineKeyboardButton(' Group', url='https://t.me/fluxxfiles')
            ],[
            types.InlineKeyboardButton('🔥 Source Code 🔥', url='https://t.me/fluxxfiles/222')
    ]]))
